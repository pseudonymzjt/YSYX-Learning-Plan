...
struct value *stmt(struct func *, struct scope *, struct type **);
struct value *stmt_expr(struct func *, struct scope *, struct type **);
...
struct asm_operand {
  char *constraint;
  struct expr *expr;
  struct asm_operand *next;
};

void funcasm(struct func *, char *, struct asm_operand *, struct asm_operand *, struct asm_operand *);
