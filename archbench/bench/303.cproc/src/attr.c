...
static bool parseattr(struct attr *a, enum attrkind allowed, enum attrprefix prefix) {
...
static bool attrspec(struct attr *a, enum attrkind allowed) {
...
bool attr(struct attr *a, enum attrkind allowed) {
...
static bool gnuattrspec(struct attr *a, enum attrkind allowed) {
...
bool gnuattr(struct attr *a, enum attrkind allowed) {
