...
static void SetMbParams(mbStorage_t *pMb, sliceHeader_t *pSlice, u32 sliceId, i32 chromaQpIndexOffset);
...
u32 h264bsdDecodeSliceData(strmData_t *pStrmData, storage_t *pStorage, image_t *currImage,
  ...
  do {
    ...
    SetMbParams(pStorage->mb + currMbAddr, pSliceHeader, pStorage->slice->sliceId,
    ...
    if (skipRun) {
      ...
      prevSkipped = HANTRO_FALSE;
      tmp = h264bsdDecodeMacroblockLayer(pStrmData, mbLayer, pStorage->mb + currMbAddr, pSliceHeader->sliceType,
    ...
    tmp = h264bsdDecodeMacroblock(pStorage->mb + currMbAddr, mbLayer, currImage, pStorage->dpb, &qpY, currMbAddr,
    ...
    currMbAddr = h264bsdNextMbAddress(pStorage->sliceGroupMap, pStorage->picSizeInMbs, currMbAddr);
...
void SetMbParams(mbStorage_t *pMb, sliceHeader_t *pSlice, u32 sliceId, i32 chromaQpIndexOffset) {
