...
static void DecodeInterleavedMap(u32 *map, u32 numSliceGroups, u32 *runLength, u32 picSize);

static void DecodeDispersedMap(u32 *map, u32 numSliceGroups, u32 picWidth, u32 picHeight);

static void DecodeForegroundLeftOverMap(u32 *map, u32 numSliceGroups, u32 *topLeft, u32 *bottomRight, u32 picWidth,
                                        u32 picHeight);

static void DecodeBoxOutMap(u32 *map, u32 sliceGroupChangeDirectionFlag, u32 unitsInSliceGroup0, u32 picWidth,
                            u32 picHeight);

static void DecodeRasterScanMap(u32 *map, u32 sliceGroupChangeDirectionFlag, u32 sizeOfUpperLeftGroup, u32 picSize);

static void DecodeWipeMap(u32 *map, u32 sliceGroupChangeDirectionFlag, u32 sizeOfUpperLeftGroup, u32 picWidth,
                          u32 picHeight);
...
void DecodeInterleavedMap(u32 *map, u32 numSliceGroups, u32 *runLength, u32 picSize) {
...
void DecodeDispersedMap(u32 *map, u32 numSliceGroups, u32 picWidth, u32 picHeight) {
...
void DecodeForegroundLeftOverMap(u32 *map, u32 numSliceGroups, u32 *topLeft, u32 *bottomRight, u32 picWidth,
                                 u32 picHeight) {
...
void DecodeBoxOutMap(u32 *map, u32 sliceGroupChangeDirectionFlag, u32 unitsInSliceGroup0, u32 picWidth, u32 picHeight) {
...
void DecodeRasterScanMap(u32 *map, u32 sliceGroupChangeDirectionFlag, u32 sizeOfUpperLeftGroup, u32 picSize) {
...
void DecodeWipeMap(u32 *map, u32 sliceGroupChangeDirectionFlag, u32 sizeOfUpperLeftGroup, u32 picWidth, u32 picHeight) {
  ...
  for (j = 0; j < picWidth; j++)
    for (i = 0; i < picHeight; i++)
      if (k++ < sizeOfUpperLeftGroup)
        ...
        map[i * picWidth + j] = 1 - (u32)sliceGroupChangeDirectionFlag;
}
...
void h264bsdDecodeSliceGroupMap(u32 *map, picParamSet_t *pps, u32 sliceGroupChangeCycle, u32 picWidth, u32 picHeight) {
  ...
  if (pps->sliceGroupMapType > 2 && pps->sliceGroupMapType < 6) {
    ASSERT(pps->sliceGroupChangeRate && pps->sliceGroupChangeRate <= picSize);
    ...
    if (pps->sliceGroupMapType == 4 || pps->sliceGroupMapType == 5)
      sizeOfUpperLeftGroup = pps->sliceGroupChangeDirectionFlag ? (picSize - unitsInSliceGroup0) : unitsInSliceGroup0;
  }

  switch (pps->sliceGroupMapType) {
    case 0: DecodeInterleavedMap(map, pps->numSliceGroups, pps->runLength, picSize); break;

    case 1: DecodeDispersedMap(map, pps->numSliceGroups, picWidth, picHeight); break;

    case 2:
      DecodeForegroundLeftOverMap(map, pps->numSliceGroups, pps->topLeft, pps->bottomRight, picWidth, picHeight);
      break;

    case 3: DecodeBoxOutMap(map, pps->sliceGroupChangeDirectionFlag, unitsInSliceGroup0, picWidth, picHeight); break;

    case 4: DecodeRasterScanMap(map, pps->sliceGroupChangeDirectionFlag, sizeOfUpperLeftGroup, picSize); break;

    case 5: DecodeWipeMap(map, pps->sliceGroupChangeDirectionFlag, sizeOfUpperLeftGroup, picWidth, picHeight); break;
