 ...
 * Exp-Golomb codes */
static const u8 codedBlockPatternIntra4x4[48] = {47, 31, 15, 0,  23, 27, 29, 30, 7,  11, 13, 14, 39, 43, 45, 46,
                                                 16, 3,  5,  10, 12, 19, 21, 26, 28, 35, 37, 42, 44, 1,  2,  4,
                                                 8,  17, 18, 20, 24, 6,  9,  22, 25, 32, 33, 34, 36, 40, 38, 41};

static const u8 codedBlockPatternInter[48] = {0,  16, 1,  2,  4,  8,  32, 3,  5,  10, 12, 15, 47, 7,  11, 13,
...
u32 h264bsdDecodeExpGolombSigned(strmData_t *pStrmData, i32 *value) {
  ...
  if (codeNum == BIG_CODE_NUM) {
    ...
    /* (-1)^(codeNum+1) results in positive sign if codeNum is odd,
         ...
         * negative value */
    /*lint -e702 */
    *value = (codeNum & 0x1) ? (i32)((codeNum + 1) >> 1) : -(i32)((codeNum + 1) >> 1);
    /*lint +e702 */
    return (HANTRO_OK);
  }
...
u32 h264bsdDecodeExpGolombMapped(strmData_t *pStrmData, u32 *value, u32 isIntra) {
...
u32 h264bsdDecodeExpGolombTruncated(strmData_t *pStrmData, u32 *value, u32 greaterThanOne) {
